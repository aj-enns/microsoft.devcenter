...
build {
  ...
  provisioner "powershell" {
    inline = [
      ...
      "",
      "# Enable BitLocker preparation (TPM)",
      "Write-Host 'Preparing BitLocker requirements...'",
  ...
  provisioner "powershell" {
    inline = [
      ...
      "}",
      "if ($errors.Count -eq 0 -or $errors | Where-Object { $_ -like '*Firewall*' } | Measure-Object | Select-Object -ExpandProperty Count -eq 0) {",
